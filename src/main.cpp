        ...
        if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    vector<double> ptsx_car(ptsx);
                    vector<double> ptsy_car(ptsy);
                    ...
                    double poly_inc = 2.5;	// x distance
                    int num_points = 25;		// waypoints to display
                    
                    for (int i = 1; i < num_points; i++) {
                        next_x_vals.push_back(poly_inc * i);
                        next_y_vals.push_back(polyeval(coeffs, poly_inc * i)); // using x vals to get coresponding y vals
                    }
